import type { AnalyticsResponse, BusinessDataset } from "@/lib/business-api";

const labels: Record<BusinessDataset, string> = {
  sales: "Sales",
  finance: "Finance",
  inventory: "Inventory",
  support: "Support",
...
export function DataSourceCoverage({ datasets }: { datasets: Record<BusinessDataset, AnalyticsResponse> }) {
